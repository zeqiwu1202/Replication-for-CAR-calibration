...
for (s in 1:S){
  ...
  est_cal_rfnn_g[s] = result$est[7]
  sd_cal_rfnn_g[s] = result$sd[7]
...
sd_data_list <- list(sd_cal_rf, sd_cal_nn,sd_cal_rfnn,sd_cal_rflm,
                     ...
                     sd_DML_rf, sd_DML_nn,
                     sd_cal_rf_g,sd_cal_nn_g,sd_cal_rfnn_g,sd_lin,sd_sdim)
names = c("cal_rf", "cal_nn","cal_rfnn","cal_rflin","cal_rf_g","cal_nn_g","cal_rfnn_g",
...
# file_name = sprintf("20250912_%s.csv", Model)
